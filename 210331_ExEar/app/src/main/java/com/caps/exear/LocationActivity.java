...
{
    private TrackerActivity gpsTracker;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button ShowLocationButton = (Button) findViewById(R.id.btn_locationCheck);
        ShowLocationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gpsTracker = new TrackerActivity(LocationActivity.this);
